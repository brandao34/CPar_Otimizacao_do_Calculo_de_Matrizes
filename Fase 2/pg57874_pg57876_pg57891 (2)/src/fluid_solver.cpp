...
void lin_solve(int M, int N, int O, int b, float *x, float *x0, float a, float c)
{
  ...
  do
  {
    ...
    // Fase "vermelha"
#pragma omp parallel   reduction(max : max_c) firstprivate(old_x) 
...
#pragma omp  parallel  firstprivate(dtX, dtY,dtZ ) 
#pragma omp for  nowait collapse(2)
